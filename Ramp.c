...
AppRAMPCfg_Type AppRAMPCfg =
    ...
    .VzeroStart = 1300.0f,              /* 1.3V */
    .VzeroPeak = 1300.0f,                /* 1.3V */
    .StepNumber = 200,
    .RampDuration = 100 * 1000,         /* 1666s * /
    /* Receive path configuration */
    .SampleDelay = 2.0f,                /* 1ms */
    .LPTIARtiaSel = LPTIARTIA_20K,      /* Maximum current decides RTIA value */
    .ExternalRtiaValue = 200.0f,      /* Optional external RTIA resistore value in Ohm. */
